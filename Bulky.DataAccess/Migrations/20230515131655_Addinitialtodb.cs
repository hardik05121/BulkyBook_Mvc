    ...
    public partial class Addinitialtodb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Htags", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Itags", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactUss_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactUss_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactUss_States_StateId",
                        column: x => x.StateId,
                        principalTable: "States",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Vid City", "Vivid Books", 1234567890, 66666, "IL", "999 Vid St" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactUss_CityId",
                table: "ContactUss",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactUss_CountryId",
                table: "ContactUss",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactUss_StateId",
                table: "ContactUss",
                column: "StateId");
